...
import bank.organization.JeweleryBank;
...
public class MainClass {
    ...
    public static void main(String[] args) {
        ...
        Contribution<Gold> searched = jeweleryBank.findContribution(client8);
        searched.print();
        ...
        SafeBox<?> goldSafeBox = new SafeBox<>(gold, 3);
        Diamond diamond = new Diamond(20, new Currency(500, Currency.BYN), "White", 'A');
        SafeBox<?> diamondSafeBox = new SafeBox<>(diamond, 12);
        Currency currency = new Currency(120000, Currency.EURO);
        SafeBox<?> currencySafeBox = new SafeBox<>(currency, 7);
        goldSafeBox.print();
        System.out.println("\n");
    ...
    private static void printerMethod(List<Printable> printables) {
